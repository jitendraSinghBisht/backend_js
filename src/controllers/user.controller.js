...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //validate for empty
  //check in db
  //if found check password correct
  //else invalid username or email
  //if password correct generate access and refresh token
  //provide tokens to user for login purpose in secure cookie
  //if password incorrect error invalid password
...
const getCurrentUser = asyncHandler(async (req, res) => {
  // const user = req.user
  // const subcribtionDetails = await Subscription.findOne(user._id)
  return res
    .status(200)
